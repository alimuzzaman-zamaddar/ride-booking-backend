...
router.post("/:id/online", (0, checkAuth_1.checkAuth)("driver", "admin"), ride_controller_1.setRiderOnline);
// Route to set rider status to offline (only accessible to the rider and admins)
router.post("/:id/offline", (0, checkAuth_1.checkAuth)("driver", "admin"), ride_controller_1.setRiderOffline);
